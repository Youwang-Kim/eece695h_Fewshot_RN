...
def square_euclidean_metric(a, b):
    ...
    a = a.unsqueeze(1).expand(n, m, a.shape[1], a.shape[2], a.shape[3])
    b = b.unsqueeze(0).expand(n, m, b.shape[1], b.shape[2], b.shape[3])

    logits = torch.pow(a - b, 2).sum(dim=[2,3,4])
    return logits
...
class csv_write():
    ...
    def __init__(self, args):
        self.f = open('20202044_KimYouwang.csv', 'w', newline='')
        self.write_number = 1
